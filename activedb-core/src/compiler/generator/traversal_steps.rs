...
pub struct NestedTraversalInfo {
    ...
    pub parsed_traversal: Option<Box<crate::compiler::parser::types::Traversal>>, // Original parsed traversal for validation
...
pub struct ComputedExpressionInfo {
    ...
    pub expression: Box<crate::compiler::parser::types::Expression>,
}
...
pub struct Traversal {
    ...
    pub closure_param_name: Option<String>, // AQL closure parameter name (e.g., "e" from entries::|e|)
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match &self.weight_calculation {
            ...
            WeightCalculation::Default => {
                write!(
                    f,
                    "activedb_core::engine::traversal_core::ops::util::paths::default_weight_fn"
                )?;
            }
        }
...
impl Display for ShortestPathBFS {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "shortest_path_with_algorithm({}, {}, {}, PathAlgorithm::BFS, activedb_core::engine::traversal_core::ops::util::paths::default_weight_fn)",
            self.label
                .as_ref()
                .map_or("None".to_string(), |label| format!("Some({label})")),
            self.from
...
impl Display for ShortestPathAStar {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        write!(
            f,
            "|node| activedb_core::engine::traversal_core::ops::util::paths::property_heuristic(node, {})",
