                        ...
                        let (nested_type_name, is_first, is_variable_ref) =
                            ...
                            } = &field_info.source
                            {
                                ...
                                let trav_type_is_placeholder = match traversal_type {
                                    None => true,
                                    Some(crate::compiler::generator::traversal_steps::TraversalType::Empty) => true,
                                    Some(crate::compiler::generator::traversal_steps::TraversalType::Ref) => true, // Default traversal type
                                    Some(_) => false,
                                };
...
pub enum ReturnFieldSource {
    ...
    ComputedExpression {
        expression: Box<crate::compiler::parser::types::Expression>,
    },
}
