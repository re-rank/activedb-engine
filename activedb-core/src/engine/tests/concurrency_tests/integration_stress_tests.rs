...
/// Integration Stress Tests for ActiveDB
///
/// This test suite performs comprehensive stress testing across all major components
/// of the ActiveDB system under high concurrent load. These tests validate that:
///
...
fn setup_stress_storage() -> (Arc<ActiveDBGraphStorage>, TempDir) {
